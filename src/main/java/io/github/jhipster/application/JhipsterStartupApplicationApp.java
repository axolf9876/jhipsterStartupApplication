...
public class JhipsterStartupApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterStartupApplicationApp.class);

    private final Environment env;

    public JhipsterStartupApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterStartupApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterStartupApplicationApp.class);
